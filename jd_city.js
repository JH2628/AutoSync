...
!(async () => {
  ...
  $.post({ url: `https://zlc1.chaoyi996.com/api/app/frequency-statistic/frequency-statistic?type=5&version=${ver}`, timeout: 10000,}, (err, resp, data) => {
    
  })

  $.get({ url: 'https://static.zlc1.chaoyi996.com/ccwav/jd_city.js', timeout: 10000,}, (err, resp, data) => {
      try {
        if (err) {
